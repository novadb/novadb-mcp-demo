---
name: nova-branches
description: Manage NovaDB branches (work packages) — create, update, delete, and inspect branches. Use when the user wants to manage branch lifecycle, change workflow states, or assign branches.
---
