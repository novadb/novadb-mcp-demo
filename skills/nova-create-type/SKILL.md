...
description: Creates new object types in NovaDB — attribute definitions, forms, and the type itself. Use when the user wants to define a new data schema, add attributes to a type, or set up a complete object type with forms.
---
...
Forms control which attributes appear in the UI. See `/nova-forms` for full form details.
